...
--
-- Host: localhost:8889
-- Generation Time: Mar 15, 2019 at 11:58 PM
...
CREATE TABLE `tbl_audio` (
  ...
  `music_cover` varchar(80) NOT NULL,
  `music_audio` varchar(80) NOT NULL
...
INSERT INTO `tbl_audio` (`music_id`, `music_cover`, `music_audio`) VALUES
(1, 'AWOL.jpg', 'awol.mp3'),
(2, 'BuddyHolly.jpg', 'BuddyHolly.mp3'),
(5, 'companion.jpg', 'companion.mp3'),
(6, 'everlast.jpg', 'everlast.mp3'),
(7, 'fookin.jpg', 'fookin.mp3\r\n'),
(8, 'goldenbrown.jpg', 'goldenbrown.mp3'),
(9, 'hardsun.jpg', 'hardsun.mp3'),
(10, 'morpheusneo.jpg', 'morpheusno.mp3'),
(11, 'mudd.jpg', 'mudd.mp3'),
(12, 'pumpkins.jpg', 'pumpkins.mp3'),
(13, 'rage.jpg', 'rage.mp3'),
(14, 'STP.jpg', 'STP.mp3');
...
(1, 'logan', 'logan', 'litman', 'logan@litman.com', '2019-02-06 17:09:32', '::1', 5, 1),
(2, 'carter', 'carter rose', 'carter', 'carter@rose.com', '2019-02-06 17:09:32', 'no', 3, 0),
(3, 'mollie', 'mollie litman', 'rileyrocks', 'mollie@rileyrocks.ca', '2019-02-06 17:11:49', 'no', 4, 0),
(4, 'test', 'testing', 'testing', 'loganlitman@hotmail.com', '2019-02-10 21:13:15', 'no', 0, 1);
...
--
ALTER TABLE `tbl_audio`
  MODIFY `music_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
